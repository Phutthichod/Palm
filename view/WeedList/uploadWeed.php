...
switch ($request) {
  case 'insert':
    ...
    $sql = "INSERT INTO `db-pestlist` (`PID`, `Name`, `Alias`, `PTID`, `Charactor`, `Danger`, `lcon` , `NumPicChar`, `NumPicDanger`)
          VALUES ('','$Alias','$Name','3','$Charactor','$Danger','$Icon','1','1')";
    ...
    if (move_uploaded_file($_FILES["picstyle_insert"]["tmp_name"], "../../picture/Pest/weed/style/$id/$stylechar")) { }
    if (move_uploaded_file($_FILES["picdan_insert"]["tmp_name"], "../../picture/Pest/weed/danger/$id/$stylechar")) { }
