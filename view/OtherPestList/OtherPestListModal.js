var addModal =
    ...
    <form method="post" id="formAdd" name = "formAdd" action="add_OtherPest.php"
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                <button type="submit" name="addother" class="btn btn-success waves-effect" id="add-data">ยืนยัน</button>
