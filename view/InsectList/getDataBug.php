    ...
    <div class="row">
            ...
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel" id="silder">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="d-block w-100" src=<?php echo $src = "../../picture/Pest/insect/style/" . $row["PID"] . "/" . $row["lcon"]; ?> alt="First slide" style="height:200px;">
                    </div>
                    <!--
        ...
        <div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
            ...
            <div id="carouselExampleControls2" class="carousel slide" data-ride="carousel" id="silder">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img class="d-block w-100" src=<?php echo $src = "../../picture/Pest/insect/danger/" . $row["PID"] . "/" . $row["lcon"]; ?> alt="First slide" style="height:200px;">
                    </div>
                    <!--
                    <div class="carousel-item">
                        <img class="d-block w-100" src="../../picture/Pest/insect/01.jpg" alt="Second slide" style="height:200px;">
