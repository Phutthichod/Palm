            ...
            <div class="modal-content">
                ...
                <div class="main">
                    ...
                    <div class='row clearfix'>
                        ...
                        <div class='col-lg-8 col-md-8 col-sm-9 col-xs-6'>
                            ...
                            <div  class="img-reletive">
                                ...
                                <input type="file" id="pic-style-char" name="picstyle_insert[]" accept=".jpg"  multiple>
                            </div>
                            </div>
                            </div>
                        </div>
                    ...
                    <div class="modal-footer normal-button">
                        <button type="button" class="btn btn-success waves-effect insertSubmit" name="save" id="add-data" value="insert">ยืนยัน</button>
