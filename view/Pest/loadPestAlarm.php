...
$sql = "SELECT lpa.ID,dp.ID AS 'DIMpestID',dp.dbpestTID,dp.dbpestLID,S.Name,S.FName,S.SumSubFarm,S.SumArea,S.SumNumTree,dp.TypeTH,dt.Date,dp.Name AS 'PName',dp.Alias AS 'PAlias',dp.Charactor,dp.Danger,dpl.Icon,lp.NumPicChar,lp.NumPicDanger,lpa.PICS,lpa.Note
